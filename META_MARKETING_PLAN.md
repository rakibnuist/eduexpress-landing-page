...
```mermaid
graph TD
    A[Cold Audience - Awareness] -->|Engage| B[Warm Audience - Consideration]
    B -->|Retarget| C[Hot Audience - Conversion]
    C -->|Submit Form| D[Lead Generated]
    D -->|WhatsApp/Call| E[Qualified Student]
```
